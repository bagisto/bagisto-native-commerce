  ...
  return (
    <section className="pt-8 sm:pt-12 lg:pt-20">
      <div className="md:max-w-4.5xl mx-auto mb-6 w-full px-0 text-center xss:mb-10 md:px-36">
        <h2 className="mb-2 text-xl md:text-4xl font-semibold text-black dark:text-white xss:mb-4 xss:text-4xl">
          {title}
        </h2>
        <p className="font-normal text-black/60 dark:text-neutral-300 text-sm md:text-base">
          {description}
        </p>
      </div>
