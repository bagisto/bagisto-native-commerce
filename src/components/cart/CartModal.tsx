...
export default function CartModal({
  ...
  const { isLoading: cartIsLoading } = useCartDetail();
  const [isMounted, setIsMounted] = useState(false);
  const isLoading = !isMounted || cartIsLoading;
  ...
  const { isOpen: internalIsOpen, onOpen, onClose, onOpenChange } = useDisclosure();
